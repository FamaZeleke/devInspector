...
//        }
//
//        Button dockerCreateImagesButton = new Button("Create and Run Images");
//        DockerManager finalDockerManager = dockerManager;
//        dockerCreateImagesButton.setOnAction(event -> {
//            List<String> containerIds = finalDockerManager.createAndRunContainer();
//            outputArea.getItems().addAll(containerIds);
//        });
